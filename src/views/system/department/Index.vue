...
import { retrieveDepartments, retrieveDepartmentSubset, fetchDepartment } from '~/api/departments'
import type { Department } from '~/api/models.type'
 ...
 * 加载列表
 */
function load(row?: Department, treeNode?: unknown, resolve?: (data: Department[]) => void) {
  loading.value = true
